...
class MailService {
    ...
    void sendMail(NotificationEmail notificationEmail) {
        MimeMessagePreparator messagePreparator = mimeMessage -> {
            ...
            messageHelper.setFrom("hazem.bensalem@esprit.tn");
        ...
        try {
            ...
            throw new SpringRuntimeException("Exception occurred when sending mail to " + notificationEmail.getRecipient(), e);
        }
    }
